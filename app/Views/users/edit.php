    ...
    <form method="POST" action="<?php echo BASE_URL; ?>/users/edit/<?php echo $user['id']; ?>">
        <div class="form-grid">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="username" name="username" value="<?php echo htmlspecialchars($user['username']); ?>" placeholder="Nhập tên đăng nhập..." required>
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="role" name="role" required>
                    ...
                    <option value="leader" <?php echo $user['role'] == 'leader' ? 'selected' : ''; ?>>Trưởng Nhóm</option>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="score" name="score" value="<?php echo $user['score'] ?? 0; ?>" placeholder="Nhập điểm số...">
            </div>
