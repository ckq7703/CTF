...
<div class="create-challenge-form">
    <form method="POST" action="<?php echo BASE_URL; ?>/challenges/create">
        <div class="form-grid">
            <!-- Tiêu đề -->
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="points" name="points" value="100" placeholder="Nhập số điểm...">
            </div>
