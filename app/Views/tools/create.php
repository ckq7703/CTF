...
<div class="create-tool-form">
    <form method="POST" action="<?php echo BASE_URL; ?>/tools/create" enctype="multipart/form-data">
        <div class="form-grid">
            <!-- Tên Công cụ -->
            <div class="mb-3">
                <label for="name" class="form-label">Tên Công cụ</label>
                <input type="text" class="form-control" id="name" name="name" placeholder="Nhập tên công cụ..." required>
            </div>

            <!-- Liên kết -->
            <div class="mb-3">
                <label for="link" class="form-label">Liên kết</label>
                <input type="url" class="form-control" id="link" name="link" placeholder="Nhập liên kết...">
            </div>
            ...
            <div class="mb-3 full-width">
                ...
                <textarea class="form-control" id="guide" name="guide" rows="5" placeholder="Nhập hướng dẫn (HTML)..."></textarea>
            </div>
